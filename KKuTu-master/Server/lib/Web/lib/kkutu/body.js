...
function onGoods(e){
    ...
    ceq[($obj.group == "Mhand") ? [ "Mlhand", "Mrhand" ][Math.floor(Math.random() * 2)] : $obj.group.substr(0, 3) == "BDG" ? "BDG" : $obj.group] = id;
...
function iImage(key, sObj){
    ...
    }else if(typeof sObj == "string") sObj = { _id: (sObj === "Mbody" ? "body" : "def"), group: sObj, options: {} };
